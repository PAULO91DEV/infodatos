...
//
//     final pepExtraOfficialEntity = pepExtraOfficialEntityFromJson(jsonString);

import 'dart:convert';

List<PepExtraOfficialEntity> pepExtraOfficialEntityFromJson(String str) =>
    List<PepExtraOfficialEntity>.from(
        json.decode(str).map((x) => PepExtraOfficialEntity.fromJson(x)));

String pepExtraOfficialEntityToJson(List<PepExtraOfficialEntity> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class PepExtraOfficialEntity {
  PepExtraOfficialEntity({
  ...
  factory PepExtraOfficialEntity.fromJson(Map<String, dynamic> json) =>
      PepExtraOfficialEntity(
